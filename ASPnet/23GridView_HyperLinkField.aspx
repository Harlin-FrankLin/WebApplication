...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>23GridView_HyperLinkField</title>
</head>
<body>
        ...
        <div>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Account" DataSourceID="SqlDataSource1">
                <Columns>
                   ...
                   <asp:HyperLinkField DataTextFormatString="詳細資料" DataTextField="Account" DataNavigateUrlFormatString="23GridView_HyperLinkField-2.aspx?id={0}&n={1}" DataNavigateUrlFields="Account,Name" />
