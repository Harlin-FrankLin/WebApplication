<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="22GridView_ButtonField.aspx.cs" Inherits="ASPnet._22GridView_ButtonField" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>22GridView_ButtonField</title>
</head>
<body>
    <form id="form1" runat="server">
        <div>
           ...
           <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ConnectionString="<%$ ConnectionStrings:MySystemConnectionString1 %>" SelectCommand="SELECT * FROM [Products]" 
                >
            </asp:SqlDataSource>

            <asp:GridView GridLines="Both" CssClass="table table-hover" ID="GridView1" runat="server" AutoGenerateColumns="False" 
