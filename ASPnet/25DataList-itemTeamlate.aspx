...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>25DataList-itemTeamlate</title>
        <style>
        #container{
            width:1247px;
            margin:auto;
    ...
    <form id="form1" runat="server">
        <div id="container">
            ...
            <div id="right">
                ...
                <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1" RepeatColumns="4" CellSpacing="20" RepeatDirection="Vertical" GridLines="None">
                    <FooterTemplate>
                        This is Footer
                    </FooterTemplate>
