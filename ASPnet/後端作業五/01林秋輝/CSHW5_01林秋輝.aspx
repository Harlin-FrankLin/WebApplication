<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CSHW5_01林秋輝.aspx.cs" Inherits="ASPnet.後端作業五._01林秋輝.CSHW5_01林秋輝" %>
           ...
           <table id="tbMember">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" Display="Dynamic" ControlToValidate="txtID" runat="server" ErrorMessage="身分證為必填欄位" Text="(必填)" ForeColor="Red" Font-Size="10pt"></asp:RequiredFieldValidator>
